...
class OpencvImageWidget(gui.Image):
    ...
    def __init__(self, filename, **kwargs):
        ...
        super(OpencvImageWidget, self).__init__(self.icon, **kwargs)
...
class OpencvCropImageWidget(OpencvImageWidget, object):
    ...
    def __init__(self, x, y, w, h, **kwargs):
        ...
        self.w = w
        self.h = h
        super(OpencvCropImageWidget, self).__init__(self.icon, **kwargs)
...
class OpencvThresholdImageWidget(OpencvImageWidget, object):
    icon = "data:image/png;base64,"
    @gui.decorate_constructor_parameter_types([int])
    def __init__(self, threshold_value, **kwargs):
        self.app_instance = None
        self.threshold_value = threshold_value
        super(OpencvThresholdImageWidget, self).__init__(self.icon, **kwargs)
...
class OpencvVideoWidget(OpencvImageWidget):
    ...
    def __init__(self, video_source, framerate_hz, **kwargs):
        ...
        super(OpencvVideoWidget, self).__init__(self.icon, **kwargs)
