...
class OpencvWidget(object):
    ...
    def do(self, callback, *userdata, **kwuserdata):
        ...
        if hasattr(self.on_new_image.event_method_bound, "_js_code"):
            self.on_new_image.event_source_instance.attributes[
                self.on_new_image.event_name
            ] = self.on_new_image.event_method_bound._js_code % {
                "emitter_identifier": self.on_new_image.event_source_instance.identifier,
                "event_name": self.on_new_image.event_name,
            }
        ...
        ):  # protection against the callback replacements in the editor
...
class OpencvImage(gui.Image, OpencvWidget):
    ...
    def update(self, *args):
        if self.app_instance is None:
            ...
            if self.app_instance is None:
                self.attributes["src"] = (
                    "/%s/get_image_data?index=00" % self.identifier
                )  # gui.load_resource(self.filename)
                return
    ...
    def get_image_data(self, index=0):
        gui.Image.set_image(
            self,
            "/%(id)s/get_image_data?index=%(frame_index)s"
            % {"id": self.identifier, "frame_index": str(time.time())},
        )
        self._set_updated()
        try:
...
class OpencvImRead(OpencvImage, OpencvWidget):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific", """Image local filename""", "file", {}
    )
    def filename(self):
...
class OpencvThreshold(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The threshold value to binarize image",
        int,
        {"default": 125, "min": 0, "max": 255, "step": 1},
    )
    def threshold(self):
...
class OpencvSplit(OpencvImage):
    ...
    def on_new_image_listener(self, emitter):
        self.image_source = emitter
        self.set_image_data(emitter.img)
        if self.on_new_image_first_component.callback is not None:
            self.on_new_image_first_component()
        if self.on_new_image_second_component.callback is not None:
            self.on_new_image_second_component()
        if self.on_new_image_third_component.callback is not None:
    ...
    def do_first(self, callback, *userdata, **kwuserdata):
        ...
        if hasattr(self.on_new_image_first_component.event_method_bound, "_js_code"):
            self.on_new_image_first_component.event_source_instance.attributes[
                self.on_new_image_first_component.event_name
            ] = self.on_new_image_first_component.event_method_bound._js_code % {
                "emitter_identifier": self.on_new_image_first_component.event_source_instance.identifier,
                "event_name": self.on_new_image_first_component.event_name,
            }
        ...
        if (
            ...
            if hasattr(self, "image_source"):
                if self.image_source.img is not None:
    ...
    def do_second(self, callback, *userdata, **kwuserdata):
        ...
        if hasattr(self.on_new_image_second_component.event_method_bound, "_js_code"):
            self.on_new_image_second_component.event_source_instance.attributes[
                self.on_new_image_second_component.event_name
            ] = self.on_new_image_second_component.event_method_bound._js_code % {
                "emitter_identifier": self.on_new_image_second_component.event_source_instance.identifier,
    ...
    def do_third(self, callback, *userdata, **kwuserdata):
        ...
        if hasattr(self.on_new_image_third_component.event_method_bound, "_js_code"):
            self.on_new_image_third_component.event_source_instance.attributes[
                self.on_new_image_third_component.event_name
            ] = self.on_new_image_third_component.event_method_bound._js_code % {
                "emitter_identifier": self.on_new_image_third_component.event_source_instance.identifier,
...
class OpencvCvtColor(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The conversion constant code",
        "DropDown",
        {"possible_values": cvt_types.keys()},
    )
    ...
    def on_new_image_listener(self, emitter):
        if emitter is None or emitter.img is None:
            return
        code = (
            self.cvt_types[self.conversion_code]
            if type(self.conversion_code) == str
            else self.conversion_code
        )
...
class OpencvBitwiseNot(OpencvImage):
    ...
    icon = "data:image/png;base64," + base64.b64encode(
        cv2.imencode(
            ...
            cv2.bitwise_not(
                cv2.threshold(
                    cv2.cvtColor(sample_icon_data, cv2.COLOR_BGR2GRAY),
                    130,
                    255,
                    cv2.THRESH_BINARY,
                )[1]
...
class OpencvBitwiseAnd(OpencvImage, BinaryOperator):
    ...
    def process(self):
        if self.img1 is not None:
            if self.img2 is not None:
                self.set_image_data(
                    cv2.bitwise_and(self.img1, self.img1, mask=self.img2)
                )
...
class OpencvBitwiseOr(OpencvImage, BinaryOperator):
    ...
    def process(self):
        if self.img1 is not None:
            if self.img2 is not None:
                self.set_image_data(
                    cv2.bitwise_or(self.img1, self.img1, mask=self.img2)
                )
...
class OpencvAddWeighted(OpencvImage, BinaryOperator):
    ...
    @gui.editor_attribute_decorator(
        ...
        "The alpha value",
        float,
        {"default": 0, "min": 0, "max": 1.0, "step": 0.0001},
    )
    def alpha(self):
        return self.__alpha
    ...
    def process(self):
        if self.img1 is not None:
            if self.img2 is not None:
                self.set_image_data(
                    cv2.addWeighted(
                        self.img1, self.__alpha, self.img2, self.__beta, self.__gamma
                    )
                )
...
class OpencvBilateralFilter(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        ...
        "The filter diameter",
        int,
        {"possible_values": "", "min": 0, "max": 65535, "default": 1, "step": 1},
    )
    def diameter(self):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The filter sigma color parameter",
        int,
        {"possible_values": "", "min": 0, "max": 65535, "default": 1, "step": 1},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The filter sigma space parameter",
        int,
        {"possible_values": "", "min": 0, "max": 65535, "default": 1, "step": 1},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The filter border parameter",
        "DropDown",
        {"possible_values": border_type.keys()},
    )
    def border(self):
...
class OpencvBlurFilter(OpencvImage):
    ...
    icon = "data:image/png;base64," + base64.b64encode(
        cv2.imencode(".png", cv2.blur(sample_icon_data, (6, 6)))[1]
    ).decode("utf-8")

    @property
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The filter kernel_size",
        int,
        {"possible_values": "", "min": 0, "max": 65535, "default": 1, "step": 1},
    )
    ...
    @gui.editor_attribute_decorator(
        ...
        "The filter border parameter",
        "DropDown",
        {"possible_values": OpencvBilateralFilter.border_type.keys()},
    )
    def border(self):
        return self.__border
    ...
    def on_new_image_listener(self, emitter):
        try:
            self.image_source = emitter
            border = (
                OpencvBilateralFilter.border_type[self.border]
                if type(self.border) == str
                else self.border
            )
            self.set_image_data(
                cv2.blur(
                    emitter.img, (self.kernel_size, self.kernel_size), borderType=border
                )
            )
        except Exception:
            print(traceback.format_exc())
...
class OpencvDilateFilter(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The kernel morph shape",
        "DropDown",
        {"possible_values": morph_shape.keys()},
    )
    ...
    def __init__(
        self,
        kernel_morph_shape=cv2.MORPH_RECT,
        kernel_size=2,
        iterations=1,
        border=cv2.BORDER_CONSTANT,
        *args,
    ...
    def on_new_image_listener(self, emitter):
        try:
            ...
            _kernel_morph_shape = (
                self.morph_shape[self.kernel_morph_shape]
                if type(self.kernel_morph_shape) == str
                else self.kernel_morph_shape
            )
            kernel = cv2.getStructuringElement(
                _kernel_morph_shape, (self.kernel_size, self.kernel_size)
            )
            border = (
                OpencvBilateralFilter.border_type[self.border]
                if type(self.border) == str
            ...
            self.set_image_data(
                cv2.dilate(
                    emitter.img, kernel, iterations=self.iterations, borderType=border
                )
            )
        except Exception:
            print(traceback.format_exc())
...
class OpencvLaplacianFilter(OpencvImage):
    ...
    icon = "data:image/png;base64," + base64.b64encode(
        cv2.imencode(
            ".png",
            cv2.Laplacian(cv2.cvtColor(sample_icon_data, cv2.COLOR_BGR2GRAY), -1),
        )[1]
    ).decode("utf-8")
...
class OpencvCanny(OpencvImage):
    ...
    icon = "data:image/png;base64," + base64.b64encode(
        cv2.imencode(
            ".png",
            cv2.Canny(cv2.cvtColor(sample_icon_data, cv2.COLOR_BGR2GRAY), 50, 130),
        )[1]
    ).decode("utf-8")
    ...
    def on_new_image_listener(self, emitter):
        try:
            self.image_source = emitter
            self.set_image_data(
                cv2.Canny(emitter.img, self.threshold1, self.threshold2)
            )
        except Exception:
            print(traceback.format_exc())
...
class OpencvFindContours(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The contour retrieval mode parameter",
        "DropDown",
        {"possible_values": contour_retrieval_mode.keys()},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The contour approximation method parameter",
        "DropDown",
        {"possible_values": contour_approximation_method.keys()},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The minimum arc length of a contour",
        int,
        {
            "possible_values": "",
            "min": 0,
    ...
    @property
    @gui.editor_attribute_decorator(
        "WidgetSpecific", "When true, convex contours are discarded", bool, {}
    )
    ...
    @property
    @gui.editor_attribute_decorator(
        "WidgetSpecific", "When true, non-convex contours are discarded", bool, {}
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The minimum acceptable circularity",
        float,
        {"possible_values": "", "min": 0.0, "max": 1.0, "default": 0.0, "step": 0.01},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "The maximum acceptable circularity",
        float,
        {"possible_values": "", "min": 0.0, "max": 1.0, "default": 0.0, "step": 0.01},
    )
    ...
    def on_new_image_listener(self, emitter):
        try:
            ...
            if emitter.img is None:
                return
            _retrieval_mode = (
                self.contour_retrieval_mode[self.retrieval_mode]
                if type(self.retrieval_mode) == str
                else self.retrieval_mode
            )
            _approximation_method = (
                self.contour_approximation_method[self.approximation_method]
                if type(self.approximation_method) == str
                else self.approximation_method
            )
            major = cv2.__version__.split(".")[0]
            img = emitter.img.copy()
            if major == "3":
                img, self.contours, self.hierarchy = cv2.findContours(
                    img, _retrieval_mode, _approximation_method
                )
            else:
                ...
                if not (self.__discard_convex and cv2.isContourConvex(c)):
                    if not (self.__discard_non_convex and not cv2.isContourConvex(c)):
                        ...
                        if l > self.__min_arc_length and l < self.__max_arc_length:
                            ...
                            if (
                                area > self.__min_contour_area
                                and area < self.__max_contour_area
                            ):
                                # https://answers.opencv.org/question/21101/circularity-of-a-connected-component/
                                roundness = (4.0 * area) / (
                                    math.pi * (l / math.pi) ** 2
                                )  # 4 Area / (pi Max-diam^2)
                                if (
                                    roundness > self.__min_roundness
                                    and roundness < self.__max_roundness
                                ):
    ...
    def do_contours_result(self, callback, *userdata, **kwuserdata):
        ...
        if hasattr(self.on_new_contours_result.event_method_bound, "_js_code"):
            self.on_new_contours_result.event_source_instance.attributes[
                self.on_new_contours_result.event_name
            ] = self.on_new_contours_result.event_method_bound._js_code % {
                "emitter_identifier": self.on_new_contours_result.event_source_instance.identifier,
                "event_name": self.on_new_contours_result.event_name,
            }
...
class OpencvMatchTemplate(OpencvImage):
    ...
    @gui.editor_attribute_decorator(
        ...
        "DropDown",
        {"possible_values": matching_methods.keys()},
    )
    ...
    @gui.editor_attribute_decorator(
        "WidgetSpecific",
        "When true, the source image is shown with a rectangle in case of matching.",
        bool,
        {},
    )
    ...
    def on_new_image_listener(self, emitter):
        try:
            self.image_source = emitter
            method = (
                OpencvMatchTemplate.matching_methods[self.matching_method]
                if type(self.matching_method) == str
                else self.matching_method
            )
...
class OpencvInRangeGrayscale(OpencvImage):
    ...
    def on_new_image_listener(self, emitter):
        try:
            self.image_source = emitter
            self.set_image_data(
                cv2.inRange(emitter.img, self.threshold1, self.threshold2)
            )
        except Exception:
            print(traceback.format_exc())
