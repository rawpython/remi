...
class OpencvCrop(OpencvImage):
    ...
    def on_new_image_listener(self, emitter, image_data_as_numpy_array): #CROP
        if image_data_as_numpy_array is None:
            return
...
class OpencvThreshold(OpencvImage):
    ...
    def on_new_image_listener(self, emitter, image_data_as_numpy_array): #THRESHOLD
        try:
