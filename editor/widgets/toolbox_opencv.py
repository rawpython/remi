...
class OpencvSplit(OpencvImRead):
    ...
    icon = "data:image/png;base64,"
    @gui.decorate_constructor_parameter_types([int])
    def __init__(self, component_index_zero_based, **kwargs):
        self.component_index_zero_based = component_index_zero_based
        super(OpencvSplit, self).__init__(self.icon, **kwargs)

    def on_new_image_listener(self, emitter):
        if emitter.img is None:
            return
        bgr_components = cv2.split(emitter.img)
        self.set_image_data(bgr_components[self.component_index_zero_based])
...
class OpencvBGRtoHSV(OpencvImRead):
    ...
    def __init__(self, **kwargs):
        super(OpencvBGRtoHSV, self).__init__(self.icon, **kwargs)
