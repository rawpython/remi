...
try:
    ...
    class EPICSPlaceholder(gui.Label):
        ...
        def __init__(
            self,
            msg="In order to use EPICS widgets install pyepics \n"
...
try:
    ...
    class OPENCVPlaceholder(gui.Label):
        ...
        def __init__(
            self,
            msg="In order to use OpenCv widgets install python-opencv \n"
            + traceback.format_exc(),
        ):
...
try:
    ...
    class SIEMENSPlaceholder(gui.Label):
        ...
        def __init__(
            self,
            msg="In order to use Siemens widgets install python-snap7 \n"
            + traceback.format_exc(),
        ):
