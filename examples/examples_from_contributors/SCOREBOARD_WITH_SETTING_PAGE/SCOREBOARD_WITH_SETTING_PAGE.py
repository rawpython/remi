...
class MyApp(App):
    ...
    def ChangeColor(self, Text, Side, Num, BtUp, BtDn):
        ...
        time.sleep(
            3
        )  # I tried to make this function without use the thread but the "sleep" here frozen the interface update and I wasn't able to change
    ...
    def main(self):
        ...
        wid = gui.Container(
            width=480, height=610, style={"margin": "0px auto", "background": "black"}
        )
        # Title
        self.lbl = gui.Label(
            "SCOREBOARD",
        ...
        self.wid2 = gui.Container(
            width=230, height=350, margin="5px", style={"background": "green"}
        )
        # Container for right side
        self.wid3 = gui.Container(
            width=230, height=350, margin="5px", style={"background": "green"}
        )
        # Left side interface
        self.lblLeftName = gui.Label(
            self.Name1,
            width="95%",
            height="60px",
            style={
        ...
        self.lblLeftMatches = gui.Label(
            str(self.LeftMatchNum),
            width=30,
            height="30px",
            style={
                "margin": "0px 5px",
        ...
        self.lblRightMatches = gui.Label(
            str(self.RightMatchNum),
            width=30,
            height="30px",
            style={
                "margin": "0px 5px",
