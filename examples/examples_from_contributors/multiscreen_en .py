...
class screen1Widget(Container):
    def __init__(self, **kwargs):
        ...
        mytextbox = TextInput(
            single_line=True, hint="Result Box. You can add content on screen 2"
        )
...
class screen2Widget(Container):
    def __init__(self, **kwargs):
        ...
        mytextbox = TextInput(
            single_line=True, hint="Write something to be send to screen 1"
        )
...
class multiscreen(App):
    ...
    def main(self):
        ...
        baseContainer.children["menuContainer"].children["btnScreen2"].onclick.do(
            self.onclick_btnScreen2
        )
        baseContainer.children["menuContainer"].children["btnScreen1"].onclick.do(
            self.onclick_btnScreen1
        )
    ...
    def onclick_btnScreen2(self, emitter):
        ...
        if "screen1" in self.baseContainer.children["contentContainer"].children.keys():
            self.baseContainer.children["contentContainer"].remove_child(
                self.baseContainer.children["contentContainer"].children["screen1"]
            )
    ...
    def onclick_btnScreen1(self, emitter):
        ...
        if "screen2" in self.baseContainer.children["contentContainer"].children.keys():
            self.baseContainer.children["contentContainer"].remove_child(
                self.baseContainer.children["contentContainer"].children["screen2"]
            )
    ...
    def send_text_to_screen1(self, emitter):
        ...
        self.screen1.children["mytextbox"].set_text(
            self.screen2.children["mytextbox"].get_text()
        )
...
configuration = {
    ...
    "config_project_name": "multiscreen",
