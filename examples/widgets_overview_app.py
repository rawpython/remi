...
class MyApp(App):
    ...
    def idle(self):
        ...
        self.counter.set_text('Instance Num: ' + str(len(server.clients)))
...
if __name__ == "__main__":
    ...
    import ssl
    start(MyApp, debug=True, address='0.0.0.0', port=0, start_browser=True, multiple_instance=True, expire_time=5)
