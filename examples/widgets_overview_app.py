...
if __name__ == "__main__":
    ...
    import ssl
    start(MyApp, debug=True, address='0.0.0.0', start_browser=True, multiple_instance=True, certfile="server.crt", keyfile="server.key", ssl_version=ssl.PROTOCOL_TLSv1_2)
