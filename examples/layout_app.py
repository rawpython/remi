...
class untitled(App):
    def main(self):
        mainContainer = Container(
            width=706, height=445, margin="0px auto", style="position: relative"
        )
        subContainer = HBox(
            width=630,
            height=277,
        ...
        comboAlignItems = gui.DropDown.new_from_list(
        ...
        lblAlignItems = Label(
            "align-items",
            style="left:40px; position:absolute; top:100px; width:100px; height:30px",
        )
        mainContainer.append(lblAlignItems, "lblAlignItems")
        mainContainer.children["comboJustifyContent"].onchange.do(
            self.onchange_comboJustifyContent, vbox, hbox
        )
        mainContainer.children["comboAlignItems"].onchange.do(
            self.onchange_comboAlignItems, vbox, hbox
        )
