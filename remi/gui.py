...
class GenericDialog(Widget):
    ...
    def __init__(self, title='', message='', display_ok=True,autohide_ok=True,
                    display_cancel=True,autohide_cancel=True,**kwargs):
        """
        Parameters
        ----------
        title (str): The title of the dialog.
        message (str): The message description.
        display_ok,display_cancel: Display the OK and Cancel buttons
        autohide_ok,autohide_cancel: Hide the dialog box when the button is pressed.
        kwargs (width): An optional width for the widget (es. width=10 or width='10px' or width='10%').
        kwargs (height): An optional height for the widget (es. height=10 or height='10px' or height='10%').
        """
        super(GenericDialog, self).__init__(**kwargs)
        self.autohide_ok=autohide_ok
        self.autohide_cancel=autohide_cancel
