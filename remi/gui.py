...
class Gui(object):
    ...
    def Image(self, *args, **kwargs):
        ...
        image = self.Image_class(*args,**kwargs)
        self.scene.append(image)
        return image
    
    def FileSelectionDialog(self, *args, **kwargs):
        if self.proxy is not None:
            kwargs['proxy'] = self.proxy
        fsd = self.FileSelectionDialog_class(*args,**kwargs)
        self.scene.append(fsd)
        return fsd
    ...
    def proxy(url, proxy_):
        if proxy_ is not None:
            ...
            if len(x.groups())!=0:
                tag = x.groups()[0]
                return  url.replace(f"{tag}",f"/proxy/{proxy_['port']}{tag}")
        else:
            return url      
    ...
    class EventSource(object):
        ...
        def setup_event_methods(self):
            ...
            for (method_name, method) in inspect.getmembers(self, predicate=a_method_not_builtin):
                ...
                e = Gui.ClassEventConnector(self, method_name, method)
    ...
    class _EventDictionary(dict, EventSource):
        ...
        changed = False
        def __init__(self, *args, **kwargs):
            super(Gui._EventDictionary, self).__init__(*args, **kwargs)
            Gui.EventSource.__init__(self, *args, **kwargs)

        def __setitem__(self, key, value):
            if key in self:
                if self[key] == value:
                    return
            ret = super(Gui._EventDictionary, self).__setitem__(key, value)
            self.onchange()
            return ret
        ...
        def __delitem__(self, key):
            if key not in self:
                return
            ret = super(Gui._EventDictionary, self).__delitem__(key)
            self.onchange()
            return ret
        ...
        def pop(self, key, d=None):
            if key not in self:
                return
            ret = super(Gui._EventDictionary, self).pop(key, d)
            self.onchange()
            return ret

        def clear(self):
            ret = super(Gui._EventDictionary, self).clear()
            self.onchange()
            return ret

        def update(self, d):
            ret = super(Gui._EventDictionary, self).update(d)
            self.onchange()
            return ret
    ...
    class Tag(object):
        ...
        def __init__(self, attributes=None, _type='', _class=None,  **kwargs):
            ...
            self.children = Gui._EventDictionary()
            self.attributes = Gui._EventDictionary()  # properties as class id style
            self.style = Gui._EventDictionary()  # used by Widget, but instantiated here to make gui_updater simpler
    ...
    class Widget(Tag, EventSource):
        ...
        def __init__(self, style=None, *args, **kwargs):
            ...
            super(Gui.Widget, self).__init__(**kwargs)
            Gui.EventSource.__init__(self, *args, **kwargs)
        ...
        def repr(self, changed_widgets=None):
            ...
            if changed_widgets is None:
                changed_widgets = {}
            return super(Gui.Widget, self).repr(changed_widgets)
    ...
    class Container(Widget):
        ...
        def __init__(self, children=None, *args, **kwargs):
            ...
            """
            super(Gui.Container, self).__init__(*args, **kwargs)

            self.set_layout_orientation(kwargs.get('layout_orientation', Gui.Container.LAYOUT_VERTICAL))
            if children:
        ...
        def append(self, value, key=''):
            ...
            if self.layout_orientation == Gui.Container.LAYOUT_HORIZONTAL:
    ...
    class HTML(Tag):
        def __init__(self, *args, **kwargs):
            super(Gui.HTML, self).__init__(*args, _type='html', **kwargs)
    ...
    class HEAD(Tag):
        def __init__(self, title, *args, **kwargs):
            super(Gui.HEAD, self).__init__(*args, _type='head', **kwargs)
            self.add_child('meta',
    ...
    class BODY(Container):
        ...
        def __init__(self, *args, **kwargs):
            super(Gui.BODY, self).__init__(*args, _type='body', **kwargs)
            loading_anim = Gui.Widget()
            loading_anim.css_margin = None
            loading_anim.identifier = "loading-animation"
            loading_container = Gui.Container(children=[loading_anim], style={'display':'none'})
    ...
    class GridBox(Container):
        ...
        def __init__(self, *args, **kwargs):
            super(Gui.GridBox, self).__init__(*args, **kwargs)
        ...
        def remove_child(self, child):
            ...
            super(Gui.GridBox, self).remove_child(child)
        ...
        def set_column_gap(self, value):
            ...
            if self.css_width == "auto":
                if (type(value) == int and value != 0) or value[0] != "0":
                    raise Gui.CssStyleError("Do not set column gap in combination with width auto")
            if type(value) == int:
                value = str(value) + 'px'
        ...
        def set_row_gap(self, value):
            ...
            if self.css_height == "auto":
                if (type(value) == int and value != 0) or value[0] != "0":
                    raise Gui.CssStyleError("Do not set row gap in combination with height auto")
            if type(value) == int:
                value = str(value) + 'px'
    ...
    class HBox(Container):
        ...
        def __init__(self, *args, **kwargs):
            super(Gui.HBox, self).__init__(*args, **kwargs)
    ...
    class VBox(HBox):
        ...
        def __init__(self, *args, **kwargs):
            super(Gui.VBox, self).__init__(*args, **kwargs)
    ...
    class TabBox(Container):
        ...
        """
        def __init__(self, *args, **kwargs):
            super(Gui.TabBox, self).__init__(layout_orientation=Gui.Container.LAYOUT_VERTICAL, *args, **kwargs)
            self.container_tab_titles = Gui.ListView( width="100%", layout_orientation=Gui.Container.LAYOUT_HORIZONTAL, _class = 'tabs clearfix' )
            self.container_tab_titles.onselection.do(self.on_tab_selection)
            super(Gui.TabBox, self).append(self.container_tab_titles, "_container_tab_titles")
        ...
        def append(self, widget, key=''):
            ...
            """
            key = super(Gui.TabBox, self).append(widget, key)
            self.tab_keys_ordered_list.append(key)
            self.container_tab_titles.append(Gui.ListItem(key), key)
        ...
        def remove_child(self, widget):
            ...
            self.resize_tab_titles()
            super(Gui.TabBox, self).remove_child(widget)
    ...
    class Button(Widget, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            """
            super(Gui.Button, self).__init__(*args, **kwargs)
            self.type = 'button'
            self.set_text(text)
    ...
    class TextInput(Widget, _MixinTextualWidget):
        ...
        def __init__(self, single_line=True, hint='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.TextInput, self).__init__(*args, **kwargs)
            self.type = 'textarea'
    ...
    class Label(Widget, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            """
            super(Gui.Label, self).__init__(*args, **kwargs)
            self.type = 'p'
            self.set_text(text)
    ...
    class Progress(Widget):
        ...
        def __init__(self, value=0, _max=100, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.Progress, self).__init__(*args, **kwargs)
            self.type = 'progress'
    ...
    class GenericDialog(Container):
        ...
        def __init__(self, title='', message='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Container.__init__()
            """
            super(Gui.GenericDialog, self).__init__(*args, **kwargs)
    ...
    class InputDialog(GenericDialog):
        ...
        def __init__(self, title='Title', message='Message', initial_value='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Container.__init__()
            """
            super(Gui.InputDialog, self).__init__(title, message, *args, **kwargs)
    ...
    class ListView(Container):
        ...
        def __init__(self, selectable=True, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.ListView, self).__init__(*args, **kwargs)
            self.type = 'ul'
        ...
        def append(self, value, key=''):
            ...
            if isinstance(value, type('')) or isinstance(value, type(u'')):
                value = Gui.ListItem(value)

            keys = super(Gui.ListView, self).append(value, key=key)
            if type(value) in (list, tuple, dict):
                for k in keys:
    ...
    class ListItem(Widget, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.ListItem, self).__init__(*args, **kwargs)
            self.type = 'li'
            self.set_text(text)
    ...
    class DropDown(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.DropDown, self).__init__(*args, **kwargs)
            self.type = 'select'
        ...
        def new_from_list(cls, items, **kwargs):
            ...
            obj = cls(**kwargs)
            for item in items:
                obj.append(Gui.DropDownItem(item))
            if item is not None:
                try:
        ...
        def append(self, value, key=''):
            if isinstance(value, type('')) or isinstance(value, type(u'')):
                value = Gui.DropDownItem(value)
            keys = super(Gui.DropDown, self).append(value, key=key)
    ...
    class DropDownItem(Widget, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                kwargs: See Widget.__init__()
            """
            super(Gui.DropDownItem, self).__init__(*args, **kwargs)
            self.type = 'option'
            self.value = text
            self.set_text(text)
        ...
        def set_text(self, text):
            ...
            Args:
                text (str): The string label of the Widget.
            """
            Gui._MixinTextualWidget.set_text(self, text)
    ...
    class Image_class(Widget):
        ...
        def __init__(self, image='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.Image_class, self).__init__(*args, **kwargs)
            self.type = 'img'
            self.attributes['src'] = Gui.proxy(image, self.proxy)
    ...
    class Table(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.Table, self).__init__(*args, **kwargs)
        ...
        def append(self, value, key=''):
            keys = super(Gui.Table, self).append(value, key)
            if type(value) in (list, tuple, dict):
                for k in keys:
    ...
    class TableWidget(Table):
        ...
        def __init__(self, n_rows=2, n_columns=2, use_title=True, editable=False, *args, **kwargs):
            ...
            super(Gui.TableWidget, self).__init__(*args, **kwargs)
        ...
        def _update_first_row(self):
            cl = Gui.TableEditableItem if self._editable else Gui.TableItem
            if self.__use_title:
                cl = Gui.TableTitle
    ...
    class TableRow(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.TableRow, self).__init__(*args, **kwargs)
            self.type = 'tr'
            self.style['float'] = 'none'

        def append(self, value, key=''):
            if isinstance(value, type('')) or isinstance(value, type(u'')):
                value = Gui.TableItem(value)
            keys = super(Gui.TableRow, self).append(value, key)
            if type(value) in (list, tuple, dict):
                for k in keys:
    ...
    class TableEditableItem(Container, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Container.__init__()
            """
            super(Gui.TableEditableItem, self).__init__(*args, **kwargs)
            self.type = 'td'
            self.editInput = Gui.TextInput()
    ...
    class TableItem(Container, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Container.__init__()
            """
            super(Gui.TableItem, self).__init__(*args, **kwargs)
            self.type = 'td'
            self.set_text(text)
    ...
    class TableTitle(TableItem, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.TableTitle, self).__init__(text, *args, **kwargs)
            self.type = 'th'
    ...
    class Input(Widget):
        ...
        def __init__(self, input_type='', default_value='', *args, **kwargs):
            ...
            super(Gui.Input, self).__init__(*args, **kwargs)
            self.type = 'input'
    ...
    class CheckBoxLabel(HBox):
        ...
        def __init__(self, label='checkbox', checked=False, user_data='', **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.CheckBoxLabel, self).__init__(**kwargs)
            self._checkbox = Gui.CheckBox(checked, user_data)
    ...
    class CheckBox(Input):
        ...
        def __init__(self, checked=False, user_data='', **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.CheckBox, self).__init__('checkbox', user_data, **kwargs)
    ...
    class SpinBox(Input):
        ...
        def __init__(self, default_value=0, min_value=0, max_value=65535, step=1, allow_editing=True, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SpinBox, self).__init__('number', str(default_value), **kwargs)
    ...
    class Slider(Input):
        ...
        def __init__(self, default_value=0, min=0, max=65535, step=1, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.Slider, self).__init__('range', default_value, **kwargs)
    ...
    class ColorPicker(Input):
        ...
        def __init__(self, default_value='#995500', **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.ColorPicker, self).__init__('color', default_value, **kwargs)
    ...
    class Date(Input):
        ...
        def __init__(self, default_value='2015-04-13', **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.Date, self).__init__('date', default_value, **kwargs)


    class Datalist(Container):
        def __init__(self, options=None, *args, **kwargs):
            super(Gui.Datalist, self).__init__(*args, **kwargs)
            self.type = 'datalist'
        ...
        def append(self, options, key=''):
            ...
            if not isinstance(options, Gui.DatalistItem):
    ...
    class DatalistItem(Widget, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                kwargs: See Widget.__init__()
            """
            super(Gui.DatalistItem, self).__init__(*args, **kwargs)
            self.type = 'option'
            self.set_text(text)
    ...
    class SelectionInput(Input):
        ...
        def attr_datalist_identifier(self, value): 
            if isinstance(value, Gui.Datalist):
        ...
        def __init__(self, default_value="", input_type="text", *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SelectionInput, self).__init__(input_type, default_value, *args, **kwargs)
    ...
    class SelectionInputWidget(Container):
        ...
        def __init__(self, iterable_of_str=None, default_value="", input_type='text', *args, **kwargs):
            super(Gui.SelectionInputWidget, self).__init__(*args, **kwargs)
            options = None
            if iterable_of_str:
                options = list(map(Gui.DatalistItem, iterable_of_str))
            self.datalist = Gui.Datalist(options)
            self.selection_input = Gui.SelectionInput(default_value, input_type, style={'top':'0px', 
    ...
    class GenericObject(Widget):
        ...
        def __init__(self, filename, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.GenericObject, self).__init__(**kwargs)
            self.type = 'object'
    ...
    class FileFolderNavigator(GridBox):
        ...
        def __init__(self, multiple_selection = False, selection_folder = ".", allow_file_selection = True, allow_folder_selection = False, **kwargs):
            super(Gui.FileFolderNavigator, self).__init__(**kwargs)
            ...
            self.itemContainer = Gui.Container(width='100%', height='100%')
        ...
        def populate_folder_items(self, directory):
            ...
            for i in l:
                ...
                if (not is_folder) and (not self.allow_file_selection):
                    continue
                if self.proxy is not None:
                    fi = Gui.FileFolderItem(full_path, i, is_folder, proxy=self.proxy)
                else:
                    fi = Gui.FileFolderItem(full_path, i, is_folder)
    ...
    class FileFolderItem(Container):
        ...
        def __init__(self, path_and_filename, text, is_folder=False, *args, **kwargs):
            super(Gui.FileFolderItem, self).__init__(*args, **kwargs)
            self.path_and_filename = path_and_filename
            self.isFolder = is_folder
            self.icon = Gui.Widget(_class='FileFolderItemIcon')
            ...
            icon_file = Gui.proxy(icon_file, self.proxy)                                   
        ...
        def onclick(self, widget):
            return super(Gui.FileFolderItem, self).onclick()
    ...
    class FileSelectionDialog_class(GenericDialog):
        ...
        def __init__(self, title='File dialog', message='Select files and folders',
            ...
            super(Gui.FileSelectionDialog_class, self).__init__(title, message, **kwargs)
    ...
    class MenuBar(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.MenuBar, self).__init__(*args, **kwargs)
            self.type = 'nav'
    ...
    class Menu(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.Menu, self).__init__(layout_orientation=Gui.Container.LAYOUT_HORIZONTAL, *args, **kwargs)
            self.type = 'ul'
    ...
    class MenuItem(Container, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Container.__init__()
            """
            self.sub_container = Gui.Menu()
            super(Gui.MenuItem, self).__init__(*args, **kwargs)
            super(Gui.MenuItem, self).append(self.sub_container, key='subcontainer')
            self.type = 'li'
            self.set_text(text)
    ...
    class TreeView(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Container.__init__()
            """
            super(Gui.TreeView, self).__init__(*args, **kwargs)
            self.type = 'ul'
    ...
    class TreeItem(Container, _MixinTextualWidget):
        ...
        def __init__(self, text='', *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.TreeItem, self).__init__(*args, **kwargs)
        ...
        def append(self, value, key=''):
            if self.sub_container is None:
                ...
                self.sub_container = Gui.TreeView()
                super(Gui.TreeItem, self).append(self.sub_container, key='subcontainer')
            return self.sub_container.append(value, key=key)
        ...
        def onclick(self):
            ...
            if self.treeopen:
                ...
                self.attributes['treeopen'] = 'false'
            return super(Gui.TreeItem, self).onclick()
    ...
    class FileUploader(Container):
        ...
        def __init__(self, savepath='./', multiple_selection_allowed=False, accepted_files='*.*', *args, **kwargs):
            super(Gui.FileUploader, self).__init__(*args, **kwargs)
    ...
    class FileDownloader(Container, _MixinTextualWidget):
        ...
        def __init__(self, text, filename, path_separator='/', *args, **kwargs):
            super(Gui.FileDownloader, self).__init__(*args, **kwargs)
            self.type = 'a'
    ...
    class Link(Container, _MixinTextualWidget):
        ...
        def __init__(self, url='', text='', open_new_window=True, *args, **kwargs):
            super(Gui.Link, self).__init__(*args, **kwargs)
            self.type = 'a'
    ...
    class VideoPlayer(Widget):
        ...
        def __init__(self, video='', poster=None, autoplay=False, loop=False, *args, **kwargs):
            super(Gui.VideoPlayer, self).__init__(*args, **kwargs)
            self.type = 'video'
    ...
    class SvgStop(Tag):
        ...
        def __init__(self, offset='0%', color="rgb(255,255,0)", opacity=1.0, *args, **kwargs):
            super(Gui.SvgStop, self).__init__(*args, **kwargs)
            self.type = 'stop'
    ...
    class SvgGradientLinear(Tag):
        ...
        def __init__(self, x1, y1, x2, y2, *args, **kwargs):
            super(Gui.SvgGradientLinear, self).__init__(*args, **kwargs)
    ...
    class SvgGradientRadial(Tag):
        ...
        def __init__(self, cx="20%", cy="30%", r="30%", fx="50%", fy="50%", *args, **kwargs):
            super(Gui.SvgGradientRadial, self).__init__(*args, **kwargs)
    ...
    class SvgDefs(Tag):
        """ """
        def __init__(self, *args, **kwargs):
            super(Gui.SvgDefs, self).__init__(*args, **kwargs)
            self.type = 'defs'
    ...
    class Svg(Container):
        ...
        def __init__(self, *args, **kwargs):
            ...
            Args:
                kwargs: See Widget.__init__()
            """
            super(Gui.Svg, self).__init__(*args, **kwargs)
            self.type = 'svg'
    ...
    class SvgSubcontainer(Svg, _MixinSvgPosition, _MixinSvgSize):
        ...
        def __init__(self, x=0, y=0, width=100, height=100, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SvgSubcontainer, self).__init__(*args, **kwargs)
            self.type = 'svg'
            self.set_position(x, y)
            Gui._MixinSvgSize.set_size(self, width, height)
    ...
    class SvgGroup(Container, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, *args, **kwargs):
            super(Gui.SvgGroup, self).__init__(*args, **kwargs)
            self.type = 'g'
    ...
    class SvgRectangle(Widget, _MixinSvgPosition, _MixinSvgSize, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, x=0, y=0, w=100, h=100, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SvgRectangle, self).__init__(*args, **kwargs)
            self.set_position(x, y)
    ...
    class SvgImage(Widget, _MixinSvgPosition, _MixinSvgSize, _MixinTransformable):
        ...
        def __init__(self, image_data='', x=0, y=0, w=100, h=100, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SvgImage, self).__init__(*args, **kwargs)
            self.type = 'image'
    ...
    class SvgCircle(Widget, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, x=0, y=0, radius=50, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SvgCircle, self).__init__(*args, **kwargs)
            self.set_position(x, y)
    ...
    class SvgEllipse(Widget, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, x=0, y=0, rx=50, ry=30, *args, **kwargs):
            ...
            Args:
                ...
                kwargs: See Widget.__init__()
            """
            super(Gui.SvgEllipse, self).__init__(*args, **kwargs)
            self.set_position(x, y)
    ...
    class SvgLine(Widget, _MixinSvgStroke, _MixinTransformable):
        ...
        def __init__(self, x1=0, y1=0, x2=50, y2=50, *args, **kwargs):
            super(Gui.SvgLine, self).__init__(*args, **kwargs)
    ...
    class SvgPolyline(Widget, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, _maxlen=1000, *args, **kwargs):
            self.__maxlen = 0
            super(Gui.SvgPolyline, self).__init__(*args, **kwargs)
            self.type = 'polyline'
    ...
    class SvgPolygon(SvgPolyline, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        def __init__(self, _maxlen=None, *args, **kwargs):
            super(Gui.SvgPolygon, self).__init__(_maxlen, *args, **kwargs)
            self.type = 'polygon'
    ...
    class SvgText(Widget, _MixinSvgPosition, _MixinSvgStroke, _MixinSvgFill, _MixinTextualWidget, _MixinTransformable):
        ...
        def __init__(self, x=10, y=10, text='svg text', *args, **kwargs):
            super(Gui.SvgText, self).__init__(*args, **kwargs)
            self.type = 'text'
            self.set_position(x, y)
            self.set_text(text)
    ...
    class SvgPath(Widget, _MixinSvgStroke, _MixinSvgFill, _MixinTransformable):
        ...
        def __init__(self, path_value='', *args, **kwargs):
            super(Gui.SvgPath, self).__init__(*args, **kwargs)
            self.type = 'path'
